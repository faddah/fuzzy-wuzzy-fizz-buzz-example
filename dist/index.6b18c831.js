...
var fuzzyWuzzyTest = function() {
    for(var i = 1; i < 301; i++){
        if (i % 15 === 0) resultArr.push("Fuzzy-Wuzzy!");
        else if (i % 10 === 0) resultArr.push("Wuzzy!");
        else if (i % 5 === 0) resultArr.push("Fuzzy!");
        else resultArr.push(i);
    }
    resultArr.push("...wasn't he?");
    if (!results.textContent) results.textContent = resultArr.join(", ");
    else return;
};
...
},{}]},["cspiS","i3Wj0"], "i3Wj0", "parcelRequire4ec4")
